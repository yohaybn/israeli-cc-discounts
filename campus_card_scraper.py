"""Scraper for the קמפוסכרט benefits club (https://campus.style.co.il/).
...
SOURCE_KEY = "campus_card"
CLUB_NAME = "קמפוסכרט"
BASE_URL = "https://campus.style.co.il/"
LIMITATIONS = "לסטודנטים מחזיקי קמפוסכרט; רכישה דרך אתר המועדון"
