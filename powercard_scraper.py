"""Scraper for the PowerCard benefits club (https://powercard.style.co.il/).
...
SOURCE_KEY = "powercard"
CLUB_NAME = "PowerCard"
BASE_URL = "https://powercard.style.co.il/"
LIMITATIONS = "למחזיקי כרטיס PowerCard; רכישה דרך אתר המועדון"
