"""Scraper for the גולד צפון benefits club (https://goldnorth.htzone.co.il/).
...
SOURCE_KEY = "goldnorth"
CLUB_NAME = "גולד צפון"
BASE_URL = "https://goldnorth.htzone.co.il/"
LIMITATIONS = "לחברי מועדון גולד צפון; רכישה דרך אתר המועדון"
