"""Scraper for the אמדוקס benefits club (https://amdocs.style.co.il/).
...
SOURCE_KEY = "amdocs"
CLUB_NAME = "אמדוקס"
BASE_URL = "https://amdocs.style.co.il/"
LIMITATIONS = "לעובדי אמדוקס ומחזיקי כרטיס המועדון; רכישה דרך אתר המועדון"
