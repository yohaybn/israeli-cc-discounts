"""Scraper for the אגד דרייבר benefits club (https://www.eggedclub.co.il/).
...
SOURCE_KEY = "egged_driver"
CLUB_NAME = "אגד דרייבר"
BASE_URL = "https://www.eggedclub.co.il/"
LIMITATIONS = "לחברי מועדון אגד דרייבר; רכישה דרך אתר המועדון"
