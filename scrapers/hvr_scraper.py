...
def normalize_hvr_rechargeable_card_item(item, source_name="giftcard"):
    ...
    elif source_name == "giftcard":
        website = "https://www.hvr.co.il/site/pg/gift_card_store?sn=" + str(sn)
    elif source_name == "teamimcard_branches":
...
if __name__ == "__main__":
    ...
    out_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "discounts")
