"""Scraper for the תעשייה אווירית (ICARD) benefits club (https://icard.style.co.il/).
...
SOURCE_KEY = "icard"
CLUB_NAME = "תעשייה אווירית"
BASE_URL = "https://icard.style.co.il/"
LIMITATIONS = "לעובדי וגמלאי התעשייה האווירית (ICARD); רכישה דרך אתר המועדון"
