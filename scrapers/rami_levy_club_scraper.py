"""Scraper for the רמי לוי המועדון benefits club (https://rmrm.style.co.il/).
...
SOURCE_KEY = "rami_levy_club"
CLUB_NAME = "רמי לוי המועדון"
BASE_URL = "https://rmrm.style.co.il/"
LIMITATIONS = "לחברי מועדון רמי לוי; הנחות במעמד חיוב בכרטיס המועדון"
