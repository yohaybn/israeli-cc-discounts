"""Scraper for the לייף סטייל benefits club (https://lifestyle.style.co.il/).
...
SOURCE_KEY = "lifestyle_club"
CLUB_NAME = "לייף סטייל"
BASE_URL = "https://lifestyle.style.co.il/"
LIMITATIONS = "לחברי מועדון לייף סטייל; רכישה דרך אתר המועדון"
