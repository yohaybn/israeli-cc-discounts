"""Scraper for the מועדון המתנדבים benefits club (https://mitnadvim4u.style.co.il/).
...
SOURCE_KEY = "volunteers_club"
CLUB_NAME = "מועדון המתנדבים"
BASE_URL = "https://mitnadvim4u.style.co.il/"
LIMITATIONS = "לחברי מועדון המתנדבים; רכישה דרך אתר המועדון"
