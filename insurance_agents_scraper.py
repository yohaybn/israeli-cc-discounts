"""Scraper for the לשכת סוכני הביטוח benefits club (https://insurance.style.co.il/).
...
SOURCE_KEY = "insurance_agents"
CLUB_NAME = "לשכת סוכני הביטוח"
BASE_URL = "https://insurance.style.co.il/"
LIMITATIONS = "לחברי לשכת סוכני הביטוח; רכישה דרך אתר המועדון"
