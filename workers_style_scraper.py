"""Scraper for the כח לעובדים benefits club (https://workers.style.co.il/).
...
SOURCE_KEY = "koach_laovdim"
CLUB_NAME = "כח לעובדים"
BASE_URL = "https://workers.style.co.il/"
LIMITATIONS = "למחזיקי כרטיס כח לעובדים; רכישה דרך אתר המועדון"
