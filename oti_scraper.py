"""Scraper for the אותי benefits club (https://oti.style.co.il/).
...
SOURCE_KEY = "oti"
CLUB_NAME = "אותי"
BASE_URL = "https://oti.style.co.il/"
LIMITATIONS = "לחברי אותי - עמותה ישראלית לאוטיזם; רכישה דרך אתר המועדון"
