...
**סיכום: 172 מועדונים | ✅ יש סקרייפר: 78 | ⬜ טרם נכתב: 0 | ⛔ חסום טכנית: 94 | ⚖️ חסום משפטית: 0**
...
| תמורה - ארגון המורים | ⛔ חסום טכנית | - | נבדק שוב 23.9.26: דפי ההטבות ב-igm.org.il מפנים לכניסה (signin2.aspx); עמוד הכרטיס ב-max הוא שיווקי בלבד. לא JS - לוגין |
...
| באר המשאלות | ⛔ חסום טכנית | - | נבדק שוב 23.9.26: הדומיין wishingwell.co.il לא קיים (NXDOMAIN) גם מדפדפן מלא |
